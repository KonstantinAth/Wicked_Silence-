using UnityEngine;
public class Locker : HideableObject {
    public Locker(HideableObjectData hideableObjectData, PlayerMovement player, HidingCamera hidingCamera, Camera mainCamera) :
