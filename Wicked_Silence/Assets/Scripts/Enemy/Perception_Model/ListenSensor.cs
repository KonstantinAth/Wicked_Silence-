...
public class ListenSensor : Node, ISensor {
    ...
    #region Sense Player Using Their Movement "Speed" & Their DB  & Pin point their location
    public override NodeState Evaluate() {
        Debug.Log("EVALUATING => [ LISTEN SENSOR ]");
    ...
    public override void ResetNode() {
        ...
        detected = false;
        resetted = true;
        //if (!resetted && Timer.playerGotAway) {
